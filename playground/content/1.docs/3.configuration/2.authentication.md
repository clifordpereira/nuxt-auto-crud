...
> **AI Snapshot:** The `nuxt-auto-crud stack` provides a dual-layer security model. The [Core Engine] handles low-level session/JWT verification and **RBAC** enforcement, while the [Template Implementation] manages OAuth2 flows and password lifecycle management.

## 🛡️ Identity Strategies [Core Engine]
...
## 🔑 Social Identity [Template Implementation]
...
## 📧 Password Lifecycle [Template Implementation]
