...
```bash
bun add nuxt-ghost-api
# or
npm install nuxt-ghost-api
```
...
export default defineNuxtConfig({
  modules: ['@nuxthub/core', 'nuxt-ghost-api'],
...
<!-- Badges -->
[npm-version-src]: https://img.shields.io/npm/v/nuxt-ghost-api/latest.svg?style=flat&colorA=020420&colorB=00DC82
[npm-version-href]: https://npmjs.com/package/nuxt-ghost-api

[npm-downloads-src]: https://img.shields.io/npm/dm/nuxt-ghost-api.svg?style=flat&colorA=020420&colorB=00DC82
[npm-downloads-href]: https://npm.chart.dev/nuxt-ghost-api

[license-src]: https://img.shields.io/npm/l/nuxt-ghost-api.svg?style=flat&colorA=020420&colorB=00DC82
[license-href]: https://npmjs.com/package/nuxt-ghost-api
